...
local this = {
	...
	standards = {
		...
		{"shuffleteamsxp",           "Randomly place players on each team, based on XP, with a map restart",         "vote_allow_shuffleteamsxp"},
		{"shuffleteamsxp_norestart", "Randomly place players on each team, based on XP, without a map restart",         "vote_allow_shuffleteamsxp"},
